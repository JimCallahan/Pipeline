...
plsrcdir=$HOME/code-crimson/src/pipeline
plprofile=$plsrcdir/plconfig/customers/crimson/$sitep
...
#     $plsrcdir/ $MAC_HOSTNAME:/Users/$USER/code-crimson/src/pipeline

#   ssh $MAC_HOSTNAME "source .bash_profile; cd code-crimson/build/pipeline; ./bootstrap.sh $sitep"
# fi
...
#   rsync -av --exclude-from=$plsrcdir/config/excluded --delete \
#     $plsrcdir/ $WIN_HOSTNAME:/home/$USER/code-crimson/src/pipeline

#   ssh $WIN_HOSTNAME "source .bash_profile; cd code-crimson/build/pipeline; ./bootstrap.sh $sitep"
# fi
