...
plprofile=$plsrcdir/plconfig/customers/scottb08/$sitep
...
#     $plsrcdir/ $MAC_HOSTNAME:/Users/$USER/code-scottb08/src/pipeline

#   ssh $MAC_HOSTNAME "source .bash_profile; cd code-scottb08/build/pipeline; ./bootstrap.sh $sitep"
# fi
...
#   rsync -av --exclude-from=$plsrcdir/config/excluded --delete \
#     $plsrcdir/ $WIN_HOSTNAME:/home/$USER/code-scottb08/src/pipeline

#   ssh $WIN_HOSTNAME "source .bash_profile; cd code-scottb08/build/pipeline; ./bootstrap.sh $sitep"
# fi
