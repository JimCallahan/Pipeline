// PipelineJobManager.cpp : main Windows Service project file.

#include "stdafx.h"
#include <string.h>
#include "PipelineJobManagerWinService.h"

//#using <mscorlib.dll>

using namespace PipelineJobManager;
using namespace System::Text;
using namespace System::Security::Policy;
using namespace System::Reflection;

//To install/uninstall the service, type: "PipelineJobManager.exe -Install [-u]"
int _tmain(int argc, _TCHAR* argv[])
{
	...
	{
		ServiceBase::Run(gcnew PipelineJobManagerWinService());
	}
}
