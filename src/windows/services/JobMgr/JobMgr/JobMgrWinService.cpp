// JobMgr.cpp : main Windows Service project file.

#include "stdafx.h"
#include <string.h>
#include "JobMgrWinService.h"

using namespace JobMgr;
using namespace System::Text;
using namespace System::Security::Policy;
using namespace System::Reflection;

//To install/uninstall the service, type: "JobMgr.exe -Install [-u]"
int _tmain(int argc, _TCHAR* argv[])
{
	...
	{
		ServiceBase::Run(gcnew JobMgrWinService());
	}
}
