 ...
 * models referenced into the target node, and then applies any linked Syflex Caches
 * to the models. 
 * <p>
...
public class ModelReplaceSyflexAction extends BaseAction{
	...
	private static final long serialVersionUID = 2421226555638251755L;
	...
	public ModelReplaceSyflexAction() {
		super("ModelReplaceSyflex", new VersionID("1.1.0"), "SCEA",
...
//		underDevelopment();
	...
	throws PipelineException {
		...
		err.println(toCache);
		err.println(getSingleParamValue(aApplyCache));
...
//		String cltPattern = ".*/production/.*/seq.*/syf/.*_clt";
		...
		{
//			if(!sourceName.matches(cltPattern))
//				continue;
...
//			
		...
		if((preMel!=null) || (postMel != null) || (toCache) || ((!nomatchRef.isEmpty()) && (resp.equals(aRemove)))){
			err.println("This should work");
		}
		
		if((preMel!=null) || (postMel != null) || (toCache) || 
