// $Id: MyGimpEditor.java,v 1.1 2007/02/13 05:27:17 jesse Exp $
...
/*----------------------------------------------------------------------------------------*/
  ...
  MyGimpEditor()
  {
    super("MyGimp", new VersionID("1.0.0"), "SCEA",
	  "Test Gimp Plugin.", 
	  "/usr/bin/gimp");
  ...
  //returns a light process that does whatever it's supposed to...
  //overrides the baseEditor's launch()...
  //the input params are given by pipeline upon call?
  public SubProcessLight launch(FileSeq fseq, Map<String, String> env, File dir) throws PipelineException
  {
	  /*
...
*/
  ...
  private static final long serialVersionUID = 3149958110575590049L;
}
