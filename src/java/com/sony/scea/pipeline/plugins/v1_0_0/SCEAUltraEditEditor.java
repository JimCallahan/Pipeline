...
public SCEAUltraEditEditor()
  {
    super("UltraEdit", new VersionID("1.0.0"), "SCEA",
	  "The Ultra Edit text editor.", "uedit32");
    ...
    throws PipelineException
  {
	...
	//if(which == null) 
	//  throw new PipelineException
	//    ("Unable to locate the UltraEdit executable!");
  ...
  /*----------------------------------------------------------------------------------------*/
	...
	private static final long serialVersionUID = -1279770630244743385L;
}
