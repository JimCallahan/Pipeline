// $Id: BBox4f.java,v 1.2 2004/12/14 14:08:43 jim Exp $
...
{  
  ...
  {
    if((obj != null) && (obj instanceof BBox4f)) {
      BBox4f t = (BBox4f) obj;
  ...
  (
   GlueDecoder decoder  
    ...
    throws GlueException
  {
    Point4f min = (Point4f) decoder.decode("Min"); 
    if(min == null) 
      throw new GlueException("The \"Min\" entry was missing!");
    pMin = min;

    Point4f max = (Point4f) decoder.decode("Max"); 
    if(max == null) 
  ...
  private static final long serialVersionUID = -4768699580945478563L;
