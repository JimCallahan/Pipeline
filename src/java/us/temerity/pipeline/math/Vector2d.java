// $Id: Vector2d.java,v 1.1 2004/12/13 12:56:48 jim Exp $
...
/**
 * A two component vector containing double values. <P> 
 * 
 * This class is a more restricted form of Tuple2d which uses only defines the vector operator
 * methods which make geometric sense in conjunction with the Point2d class. <P> 
 */
public 
class Vector2d
  extends Tuple2d
{  
  ...
  abs() 
  {
    Vector2d rtn = new Vector2d(this);
    rtn.absolute();
    return rtn;
  }
