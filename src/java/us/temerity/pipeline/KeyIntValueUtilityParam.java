...
/*------------------------------------------------------------------------------------------*/
/*   K E Y   I N T   V A L U E   U T I L I T Y    P A R A M                                 */
/*------------------------------------------------------------------------------------------*/

public 
class KeyIntValueUtilityParam
  extends KeyIntValueParam<UtilityParam>
  implements UtilityParam
{
  ...
  private static final long serialVersionUID = 8378003262749986064L;
}
