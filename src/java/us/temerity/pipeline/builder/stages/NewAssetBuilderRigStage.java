  ...
  extends MayaBuildStage
{
  ...
  /**
   * This constructor will initialize the stage and then run build to generate the rig node.
   * 
   * @param context
  ...
  (
    ...
    throws PipelineException
  {
    super("NewAssetBuilderRig", "Stage to build the rig scene", context, mayaContext, nodeName,
      true);
