  ...
  extends MayaFileStage
{
    ...
    throws PipelineException
  {
    ...
    setUnits();
    addSingleParam("RootDAGNode", rootDAG);
    addSingleParam("ImportSet", importSet);
    addSingleParam("BeginFrame", beginFrame);
  }
    ...
    throws PipelineException
  {
	...
	addSecondarySourceParam(exportNode, secPat, "Order", order);
      }
    }
    for (String assetName : assetInfo.keySet()) {
      ...
      addLink(mod);
      addSourceParam(assetName, "PrefixName", prefix);
    }
  }
}
