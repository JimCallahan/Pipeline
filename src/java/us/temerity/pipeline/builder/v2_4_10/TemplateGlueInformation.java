// $Id: TemplateGlueInformation.java,v 1.1 2009/10/09 04:40:08 jesse Exp $
  ...
  implements Glueable
{
  ...
  /**
   * Copy constructor for converting v2.4.3 template to v2.3.10 template.
   * 
   * @param oldInfo
   *   The v2.4.3 TemplateGlueInformation file.
   */
  public 
  TemplateGlueInformation
  (
  ...
  )
  {
    ...
    setReplacementParamNames(oldInfo.getReplacementParamNames());
    
    setContexts(oldInfo.getContexts());
    setContextDefaults(oldInfo.getContextDefaults());
    setContextParamNames(oldInfo.getContextParamNames());
    
    setNodesInTemplate(oldInfo.getNodesInTemplate());
    
    setFrameRanges(oldInfo.getFrameRanges());
    setFrameRangeDefaults(oldInfo.getFrameRangeDefaults());
  ...
  setFrameRanges
  (
    MappedSet<String, String> frameRanges  
  )
  {
    if (frameRanges == null)
      pFrameRanges = new MappedSet<String, String>();
    ...
    throws GlueException
  {
    ...
    
    {
      ...
      if (o != null)
        pFrameRanges = (MappedSet<String, String>) o;
    }
