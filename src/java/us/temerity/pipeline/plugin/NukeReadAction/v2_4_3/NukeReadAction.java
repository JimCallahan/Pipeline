// $Id: NukeReadAction.java,v 1.1 2008/03/09 12:42:45 jim Exp $
 ...
 *   Read Name <BR>
 *   <DIV style="margin-left: 40px;">
 *     The name to give the created Nuke Read node.  Can be left unset to leave the Read
 *     node unnamed.
 *   </DIV> <BR>
 *   <P>  
 * 
  ...
  extends NukeActionUtils
{
  ...
  NukeReadAction() 
  {
    super("NukeRead", new VersionID("2.4.3"), "Temerity", 
    ...
    
    {
      ActionParam param = 
        ...
        (aReadName,
         "The name to give the created Nuke Read node.  Can be left unset to leave the " + 
         "Read node unnamed.", 
         null);
      addSingleParam(param);
    } 
    ...
    throws PipelineException
  {
    ...
    try {    
      ...
      String readName = getSingleStringParamValue(aReadName); 
      if(readName != null) 
        out.write(" name " + readName + "\n"); 
  ...
  private static final long serialVersionUID = 3019129806045752714L;

  public static final String aImageSource = "ImageSource";

  public static final String aReadName      = "ReadName"; 
