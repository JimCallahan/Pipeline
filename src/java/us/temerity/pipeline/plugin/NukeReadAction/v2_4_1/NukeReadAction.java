// $Id: NukeReadAction.java,v 1.1 2008/02/04 12:09:57 jim Exp $
  ...
  extends NukeActionUtils
{
  ...
  NukeReadAction() 
  {
    super("NukeRead", new VersionID("2.4.1"), "Temerity", 
    ...
    throws PipelineException
  {
    ...
    try {    
      ...
      out.write(" colorspace " + getSingleStringParamValue(aColorspace) + "\n" +
                " premultiplied " + getSingleBooleanParamValue(aPremultiplied) + "\n" + 
  ...
  private static final long serialVersionUID = 7045430351907751891L;
