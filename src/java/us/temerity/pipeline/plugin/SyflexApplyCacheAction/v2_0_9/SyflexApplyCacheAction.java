// $Id: SyflexApplyCacheAction.java,v 1.3 2008/01/20 06:42:17 jim Exp $
...
/*------------------------------------------------------------------------------------------*/
/*   S Y F L E X   A P P L Y   C A C H E   A C T I O N                                      */
/*------------------------------------------------------------------------------------------*/

public 
class SyflexApplyCacheAction 
  extends BaseAction
{
  /*----------------------------------------------------------------------------------------*/
      ...
      for (String source : cacheSources)
        {
          ...
          String cachePath = ("$WORKING" + p.getParent() + "/" + 
