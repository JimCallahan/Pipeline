...
import us.temerity.pipeline.math.Tuple3i;
import us.temerity.pipeline.math.Tuple4d;
  ...
  extends CommonActionUtils
{
  ...
  MRayOptionsAction() 
  {
    super("MRayOptions", new VersionID("2.4.3"), "Temerity",
	...
	new LayoutGroup("Contrast", "Settings related to contrast", true);
        add(new Tuple4dActionParam(aContrast, dContrast, new Tuple4d(0.1, 0.1, 0.1, 0.1)), contrastGroup);
      contrastGroup.addSeparator();
        add(new Tuple4dActionParam(aTimeContrast, dTimeContrast, new Tuple4d(0.2, 0.2, 0.2, 0.2)), contrastGroup);
	...
	add(new EnumActionParam(aAcceleration, dAcceleration, "bsp", options), renderingGroup);
      ...
      renderingGroup.addSeparator();
      add(new Tuple3iActionParam(aGridRes, dGridRes, new Tuple3i(0, 0, 0)), renderingGroup);
	...
	add(new Tuple4dActionParam(aCausticsScale, dCausticsScale, new Tuple4d(1.0, 1.0, 1.0, 1.0)), causticsGroup);
      }
	...
	add(new Tuple4dActionParam(aGlobIllmScale, dGlobIllmScale, new Tuple4d(1.0, 1.0, 1.0, 1.0)), giGroup);
      }
	...
	add(new Tuple4dActionParam(aPhotVolScale, dPhotVolScale, new Tuple4d(1.0, 1.0, 1.0, 1.0)), pvGroup);
      }
	...
	new LayoutGroup("FinalGatherScale", "Settings related to Final Gathering Scale", false);
      {
	add(new Tuple4dActionParam(aFGScale, dFGScale, new Tuple4d(1.0, 1.0, 1.0, 1.0)), fgScale);
	fgScale.addSeparator();
	add(new Tuple4dActionParam(aFGSecScale, dFGSecScale, new Tuple4d(1.0, 1.0, 1.0, 1.0)), fgScale);
      }
	...
	new LayoutGroup("Parametic", "Parametric Settings", false);
      {
	add(new Tuple2dActionParam(aSubdUV, dSubdU, new Tuple2d(1.0, 1.0)), paramGroup);
      }
  ...
  {
    Tuple4d contrast = getSingleTuple4dParamValue
                         (aContrast,
                          new Range<Tuple4d>(new Tuple4d(0.0, 0.0, 0.0, 0.0), new Tuple4d(1.0, 1.0, 1.0, 1.0), true),
                          false);
    double cr = contrast.x();
    double cg = contrast.y();
    double cb = contrast.z();
    double ca = contrast.w();
    Tuple4d timeContrast = getSingleTuple4dParamValue
                             (aTimeContrast,
                              new Range<Tuple4d>(new Tuple4d(0.0, 0.0, 0.0, 0.0), new Tuple4d(1.0, 1.0, 1.0, 1.0), true),
                              false);
    double tcr = timeContrast.x();
    double tcg = timeContrast.y();
    double tcb = timeContrast.z();
    double tca = timeContrast.w();
    ...
    throws PipelineException, IOException
  {
    ...
    Tuple3i gridRes = getSingleTuple3iParamValue
                        (aGridRes,
                         new Range<Tuple3i>(new Tuple3i(0, 0, 0), null, true),
                         false);
    int grdX = gridRes.x();
    int grdY = gridRes.y();
    int grdZ = gridRes.z();
    ...
    throws PipelineException, IOException
  {
    ...
    if (caus) {
      ...
      Tuple4d causticScale = getSingleTuple4dParamValue
                               (aCausticsScale,
                                new Range<Tuple4d>(new Tuple4d(0.0, 0.0, 0.0, 0.0), new Tuple4d(1.0, 1.0, 1.0, 1.0), true),
                                false);
      double sr = causticScale.x();
      double sg = causticScale.y();
      double sb = causticScale.z();
      double sa = causticScale.w();
    ...
    if (gi) {
      ...
      Tuple4d globalIllum = getSingleTuple4dParamValue
                               (aGlobIllmScale,
                                new Range<Tuple4d>(new Tuple4d(0.0, 0.0, 0.0, 0.0), new Tuple4d(1.0, 1.0, 1.0, 1.0), true),
                                false);
      double sr = globalIllum.x();
      double sg = globalIllum.y();
      double sb = globalIllum.z();
      double sa = globalIllum.w();
    ...
    }
    {
      ...
      Tuple4d photVolScale = getSingleTuple4dParamValue
                               (aPhotVolScale,
                                new Range<Tuple4d>(new Tuple4d(0.0, 0.0, 0.0, 0.0), new Tuple4d(1.0, 1.0, 1.0, 1.0), true),
                                false);
      double sr = photVolScale.x();
      double sg = photVolScale.y();
      double sb = photVolScale.z();
      double sa = photVolScale.w();
    ...
    throws PipelineException, IOException
  {
    ...
    Tuple2d subdUV = getSingleTuple2dParamValue(aSubdUV, new Range<Tuple2d>(new Tuple2d(0.0, 0.0), null, true), false);
    double u = subdUV.x();
    double v = subdUV.y();
    ...
    throws PipelineException, IOException
  {
    ...
    Tuple4d fgScale = getSingleTuple4dParamValue
                        (aFGScale,
                         new Range<Tuple4d>(new Tuple4d(0.0, 0.0, 0.0, 0.0),
                                            new Tuple4d(1.0, 1.0, 1.0, 1.0), true),
                         false);
    double sr = fgScale.x();
    double sg = fgScale.y();
    double sb = fgScale.z();
    double sa = fgScale.w();
    Tuple4d fgSecScale = getSingleTuple4dParamValue
                           (aFGSecScale,
                            new Range<Tuple4d>(new Tuple4d(0.0, 0.0, 0.0, 0.0),
                                               new Tuple4d(1.0, 1.0, 1.0, 1.0), true),
                            false);
    double ssr = fgSecScale.x();
    double ssg = fgSecScale.y();
    double ssb = fgSecScale.z();
    double ssa = fgSecScale.w();
  ...
  private static final long serialVersionUID = -2409466388242444908L;

  
  /*---Sampling------------------------------------------------------------------------------*/
  public static final String aContrast       = "ContrastRGBA";
  public static final String aTimeContrast   = "TimeContrastRGBA";
  ...
  public static final String aSubdUV         = "SubdUV";
  ...
  public static final String aGridRes        = "GridRes";
  ...
  public static final String aCausticsScale  = "CausticsScaleRGBA";
  ...
  public static final String aGlobIllmScale  = "GlobIllmScaleRGBA";
  ...
  public static final String aPhotVolScale   = "PhotVolScaleRGBA";
  ...
  public static final String aFGScale        = "FGScaleRGBA";
  public static final String aFGSecScale     = "FGSecScaleRGBA";
