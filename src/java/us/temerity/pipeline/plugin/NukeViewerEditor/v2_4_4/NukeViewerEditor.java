// $Id: NukeViewerEditor.java,v 1.1 2008/10/24 17:01:17 jim Exp $
...
{  
  ...
  NukeViewerEditor()
  {
    super("NukeViewer", new VersionID("2.4.4"), "Temerity",
  ...
  private static final long serialVersionUID = -262569300575047968L;
