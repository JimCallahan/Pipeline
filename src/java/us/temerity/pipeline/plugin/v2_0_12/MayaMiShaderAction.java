  ...
  extends BaseAction
{
  ...
  MayaMiShaderAction()
  {
    super("MayaMiShader", new VersionID("2.0.12"), "Temerity",
  ...
  { 
	...
	out.println("        string $dispName = $matName + \"_disp\";");
  ...
  private static final long serialVersionUID = 8418385261092390166L;
