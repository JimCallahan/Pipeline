// $Id: QueueStatsDb.java,v 1.1 2008/08/18 16:54:27 jim Exp $
...
QueueStatsDb
{
  ...
  QueueStatsDb()
  {
	...
	(LogMgr.Kind.Ext, LogMgr.Level.Severe, 
	 ...
	 "\n" + 
	 "The driver (Connector/J 5.1) needs to be installed before this plugin can " + 
	...
	case Failed:
	  {
	    ...
	    Timestamp started = new Timestamp(info.getStartedStamp());
            ...
            switch(exitCode) {
            case 666:
              pInsertExceptionalJobSt.setLong(1, jobID);
              pInsertExceptionalJobSt.setLong(2, nodeID);
              pInsertExceptionalJobSt.setInt(3, authorID);
              pInsertExceptionalJobSt.setInt(4, viewID); 
              pInsertExceptionalJobSt.setInt(5, actionID); 
              pInsertExceptionalJobSt.setInt(6, hosts.get(info.getHostname())); 
              pInsertExceptionalJobSt.setString(7, info.getState().toString());
              pInsertExceptionalJobSt.setInt(8, exitCode);
              pInsertExceptionalJobSt.setTimestamp(9, submitted);
              pInsertExceptionalJobSt.setTimestamp(10, started);
              pInsertExceptionalJobSt.setTimestamp(11, completed);
              pInsertExceptionalJobSt.executeUpdate();
              break;
            ...
            default:
              ...
              pInsertCompletedJobSt.setInt(8, exitCode);
    ...
    throws SQLException
  {
	...
	("INSERT INTO jobs (job_id, node_id, author_id, view_id, action_id, " + 
	 ...
	 "VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
      pInsertExceptionalJobSt = pConnect.prepareStatement(sql);
    }
  ...
  private PreparedStatement  pInsertExceptionalJobSt; 
