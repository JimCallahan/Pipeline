// $Id: MayaBuildAction.java,v 1.1 2007/06/19 18:24:50 jim Exp $
...
/*----------------------------------------------------------------------------------------*/
  ...
  MayaBuildAction() 
  {
    super("MayaBuild", new VersionID("2.0.12"), "Temerity",
  ...
  getInitialSourceParams()
  {
	...
	(aNameSpace,
	 "Should Maya use the namespace flag to do the import. Highly recomended to turn " + 
	 "this on.",
	 true);
      params.put(param.getName(), param);
    }
  ...
  private static final long serialVersionUID = 5961571350828220186L;
}
