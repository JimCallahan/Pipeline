...
package us.temerity.pipeline.plugin.NukeCatCompAction.v2_6_3;
...
{  
  ...
  NukeCatCompAction() 
  {
    super("NukeCatComp", new VersionID("2.6.3"), "Temerity",
  ...
  { 
                ...
                if(line.startsWith("Read {"))
                  ...
                  if(isWrite) {
                    ...
                    if((targetNukePattern != null) && targetNukePattern.equals(npat)) {
                      Path wpath = new Path(agenda.getTargetPath(), npat);
                      out.write(" file " + wpath + "\n"); 
                      wasWritten = true;
                    }
    ...
    if(mode.equals(aConcatenate)) {
      ...
      return createSubProcess(agenda, getNukeProgram(agenda), args, agenda.getEnvironment(), 
                              getTempDir(agenda), outFile, errFile);
    }
  }
  ...
  private static final long serialVersionUID = 9216804115469634992L;
