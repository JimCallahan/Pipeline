// $Id: NukeCatCompAction.java,v 1.1 2008/02/14 18:46:00 jim Exp $
...
{  
  ...
  NukeCatCompAction() 
  {
    super("NukeCatComp", new VersionID("2.4.2"), "Temerity",
              ...
              while(true) {
                ...
                if(line.startsWith("Read {"))
                  ...
                  if(isWrite) {
                    ...
                    if(targetNukePattern.equals(npat)) {
                      out.write(" file ./" + npat + "\n"); 
                      wasWritten = true;
                    }
                    else {
  ...
  private static final long serialVersionUID = 3655840074355547410L;
