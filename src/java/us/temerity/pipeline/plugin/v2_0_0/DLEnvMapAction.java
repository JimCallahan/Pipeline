// $Id: DLEnvMapAction.java,v 1.4 2006/05/07 21:30:13 jim Exp $
...
{  
  ...
  DLEnvMapAction() 
  {
    super("DLEnvMap", new VersionID("2.0.0"), "Temerity",
  ...
  private static final long serialVersionUID = -6369147698535739820L;
