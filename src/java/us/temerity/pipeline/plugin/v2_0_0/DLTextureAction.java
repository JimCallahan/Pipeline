// $Id: DLTextureAction.java,v 1.3 2005/09/07 19:17:08 jim Exp $
...
{  
  ...
  DLTextureAction() 
  {
    super("DLTexture", new VersionID("2.0.0"), "Temerity", 
	  "Generates optimized 3Delight textures from source images.");
  ...
  private static final long serialVersionUID = -6000111750894224286L;
