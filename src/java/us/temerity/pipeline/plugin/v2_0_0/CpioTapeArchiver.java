// $Id: CpioTapeArchiver.java,v 1.5 2007/03/28 20:00:41 jim Exp $
...
{  
  ...
  CpioTapeArchiver()
  {
    super("CpioTape", new VersionID("2.0.0"), "Temerity",
  ...
  private static final long serialVersionUID = 1902846812959896662L;
