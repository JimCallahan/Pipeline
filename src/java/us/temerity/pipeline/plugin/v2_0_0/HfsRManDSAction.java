// $Id: HfsRManDSAction.java,v 1.3 2005/09/07 19:17:08 jim Exp $
...
{  
  ...
  HfsRManDSAction() 
  {
    super("HfsRManDS", new VersionID("2.0.0"), "Temerity",
  ...
  private static final long serialVersionUID = -5264600820070647957L;
