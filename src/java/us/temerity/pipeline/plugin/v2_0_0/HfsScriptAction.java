// $Id: HfsScriptAction.java,v 1.3 2005/09/07 19:17:08 jim Exp $
...
{  
  ...
  HfsScriptAction() 
  {
    super("HfsScript", new VersionID("2.0.0"), "Temerity",
  ...
  private static final long serialVersionUID = -6954101505649211358L;
