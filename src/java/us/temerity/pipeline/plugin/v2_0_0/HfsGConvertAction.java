// $Id: HfsGConvertAction.java,v 1.3 2005/09/07 19:17:08 jim Exp $
...
{  
  ...
  HfsGConvertAction() 
  {
    super("HfsGConvert", new VersionID("2.0.0"), "Temerity",
  ...
  private static final long serialVersionUID = 4663237817521803402L;
