// $Id: MayaRenderAction.java,v 1.5 2006/05/07 21:30:13 jim Exp $
...
{  
  ...
  MayaRenderAction() 
  {
    super("MayaRender", new VersionID("2.0.0"), "Temerity",
  ...
  private static final long serialVersionUID = 1421239150934264585L;
