// $Id: GelEnvMapAction.java,v 1.1 2006/01/22 21:00:58 jim Exp $
...
/*------------------------------------------------------------------------------------------*/
/*   G E L   E N V   M A P   A C T I O N                                                    */
/*------------------------------------------------------------------------------------------*/

/** 
 * Generates optimized Gelato latitude/longitude environment maps from source images. 
 * 
...
{  
  ...
  GelEnvMapAction() 
  {
    super("GelEnvMap", new VersionID("2.0.0"), "Temerity",
	  "Generates optimized Gelato latitude/longitude environment maps from " + 
	  "source images.");
  ...
  private static final long serialVersionUID = -4640311375187355438L;
