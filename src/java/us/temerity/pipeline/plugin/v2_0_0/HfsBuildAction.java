// $Id: HfsBuildAction.java,v 1.3 2005/09/07 19:17:08 jim Exp $
...
{  
  ...
  HfsBuildAction() 
  {
    super("HfsBuild", new VersionID("2.0.0"), "Temerity",
  ...
  private static final long serialVersionUID = -4434515067701039361L;
