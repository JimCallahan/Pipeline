// $Id: AirEnvMapAction.java,v 1.5 2006/11/22 09:08:01 jim Exp $
...
{  
  ...
  AirEnvMapAction() 
  {
    super("AirEnvMap", new VersionID("2.0.0"), "Temerity", 
  ...
  private static final long serialVersionUID = -9044547793460041851L;
