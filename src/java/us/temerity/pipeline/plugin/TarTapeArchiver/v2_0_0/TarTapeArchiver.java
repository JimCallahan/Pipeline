// $Id: TarTapeArchiver.java,v 1.1 2007/06/17 15:34:46 jim Exp $
...
{  
  ...
  TarTapeArchiver()
  {
    super("TarTape", new VersionID("2.0.0"), "Temerity",
  ...
  private static final long serialVersionUID = -3377982288948918480L;
