// $Id: PRCatRIBAction.java,v 1.1 2007/06/17 15:34:45 jim Exp $
 ...
 * documentation for details about <B>catrib</B>(1). <P> 
 * 
...
{  
  ...
  PRCatRIBAction() 
  {
    super("PRCatRIB", new VersionID("2.0.0"), "Temerity", 
  ...
  { 
	...
	out.write("catrib" + options + " -o " + target);
  ...
  private static final long serialVersionUID = -1962277728371882707L;
