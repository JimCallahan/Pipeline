// $Id: MayaMRayRenderAction.java,v 1.1 2007/06/19 18:24:50 jim Exp $
  ...
  extends BaseAction
{
  ...
  {
    super("MayaMRayRender", new VersionID("2.0.10"), "Temerity",
    ...
    throws PipelineException
  {
	...
	if(fseq == null) 
	  throw new PipelineException
	    ("Somehow the Maya Scene node (" + sname + ") was not one of the source nodes!");
  ...
  private static final long serialVersionUID = -2653762414186519695L;  
