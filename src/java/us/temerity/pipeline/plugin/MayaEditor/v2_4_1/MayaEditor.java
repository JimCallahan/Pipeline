// $Id: MayaEditor.java,v 1.1 2008/05/21 01:48:05 jim Exp $
  ...
  extends BaseEditor 
{
  ...
  MayaEditor() 
  {
    super("Maya", new VersionID("2.4.1"), "Temerity",
  ...
  private static final long serialVersionUID = -7709140617579577950L;
