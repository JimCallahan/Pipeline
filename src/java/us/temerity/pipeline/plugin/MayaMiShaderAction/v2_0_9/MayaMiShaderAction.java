// $Id: MayaMiShaderAction.java,v 1.1 2007/06/17 15:34:44 jim Exp $
  ...
  extends BaseAction
{
  ...
  MayaMiShaderAction()
  {
    super("MayaMiShader", new VersionID("2.0.9"), "Temerity",
	...
	(PARAM_namespace, 
	 ...
	 "shaders connected to them for exporting.  If it is a namespace, you need " + 
	 "to include the \":\".",
	 "final:"); 
      addSingleParam(param);
    }
  ...
  { 
	...
	throw new PipelineException
	  ("The following nodes (" + all + ") are attached to the node but are not " + 
	...
	out.println();
      ...
      // TODO insert selection and linking stuff here.
	...
	out.println("            error( (\"Cannot create the temporary shading engine " + 
		                          "due to naming clashes for \" + $matName  ) );");
  ...
  private static final long serialVersionUID = -3204860946654392488L;
