 ...
 *   </DIV> <BR>
 *   
 *   Use MR Light Linking <BR>
 *   <DIV style="margin-left: 40px;">
 *     Should all maya shaders be converted to using the mental ray light
 *     linking conventions.
 *   </DIV> <BR>
 *   
 *   Force Maya Light Mode <BR>
 *   <DIV style="margin-left: 40px;">
 *     Since Maya shaders cannot define a mental ray light mode, we have to force
       them to have one.  The three options here correspond to the 0, 1, and 2 values
       for mode in mental ray light linking.  Whatever is selected here will be used
       for all maya shaders that are exported, assuming mental ray light linking
       is being used.
 *   </DIV> <BR>
 * 
  ...
  extends MayaActionUtils
{
  ...
  MayaMiShaderAction()
  {
...

    {
      ...
      layout.addEntry(aForceMayaLightMode);
  ...
  { 
    ...
    int forcedMode = getSingleEnumParamIndex(aForceMayaLightMode);
	...
	out.write
        ("        elif mode == 'shader':\n" + 
         ...
         "            target.write('    \"lightMode\" " + forcedMode + ",\\n')\n" + 
         "            mode = 'lights'\n" + 
  ...
  public static final String aForceMayaLightMode = "ForceMayaLightMode";
  
  private static final long serialVersionUID = -5477619146267186183L;
