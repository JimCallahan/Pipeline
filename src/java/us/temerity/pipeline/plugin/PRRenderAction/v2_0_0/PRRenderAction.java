// $Id: PRRenderAction.java,v 1.1 2007/06/17 15:34:45 jim Exp $
...
/*------------------------------------------------------------------------------------------*/
/*   P R   R E N D E R   A C T I O N                                                        */
/*------------------------------------------------------------------------------------------*/

/** 
 * The PhotoRealistic RenderMan renderer. <P> 
 * 
...
{  
  ...
  PRRenderAction() 
  {
    super("PRRender", new VersionID("2.0.0"), "Temerity",
	  "The PhotoRealistic RenderMan renderer.");
  }
  ...
  private static final long serialVersionUID = -5526356738469222313L;
