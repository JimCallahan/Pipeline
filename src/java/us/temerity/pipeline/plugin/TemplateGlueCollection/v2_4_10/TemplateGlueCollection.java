// $Id: TemplateGlueCollection.java,v 1.1 2009/10/09 04:40:08 jesse Exp $

package us.temerity.pipeline.plugin.TemplateGlueCollection.v2_4_10;
  ...
  extends BaseBuilderCollection
{
  ...
  {
    super("TemplateGlue", new VersionID("2.4.10"), "Temerity", 
  ...
  getBuildersProvided()
  {
    String pkg = "us.temerity.pipeline.plugin.TemplateGlueCollection.v2_4_10.";
