// $Id: ShakeDiffComparator.java,v 1.1 2007/06/17 15:34:45 jim Exp $
...
{  
  ...
  ShakeDiffComparator()
  {
    super("ShakeDiff", new VersionID("2.0.9"), "Temerity", 
	  "Image comparison using Shake.", 
	  "shake");
  ...
  private static final long serialVersionUID = 4288360189081236753L;
