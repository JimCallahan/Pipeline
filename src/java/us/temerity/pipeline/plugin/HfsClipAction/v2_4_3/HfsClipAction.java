// $Id: HfsClipAction.java,v 1.1 2008/05/30 09:07:59 jim Exp $
 ...
 *   Output Operator <BR>
 *   <DIV style="margin-left: 40px;">
 *     The full Houdini path name of the output operator to evaluate in order 
 *     to generate the target channel files.  
 *   </DIV>  
 * 
...
{  
  ...
  { 
	...
	out.write("opparm " + opname + " trange off\n" +
		  "opparm " + opname + " chopoutput '" + targetSeq + "'\n");
      }
  ...
  private static final long serialVersionUID = 5681152443175962972L;
