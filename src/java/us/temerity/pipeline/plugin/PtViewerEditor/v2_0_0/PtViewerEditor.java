// $Id: PtViewerEditor.java,v 1.1 2007/06/17 15:34:45 jim Exp $
...
{  
  ...
  PtViewerEditor()
  {
    super("PtViewer", new VersionID("2.0.0"), "Temerity",
  ...
  private static final long serialVersionUID = -3736491033354021447L;
