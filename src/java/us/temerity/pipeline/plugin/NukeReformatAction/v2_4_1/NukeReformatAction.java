// $Id: NukeReformatAction.java,v 1.1 2008/02/04 12:09:57 jim Exp $
  ...
  extends PythonActionUtils
{
  ...
  NukeReformatAction() 
  {
    super("NukeReformat", new VersionID("2.4.1"), "Temerity", 
  ...
  private static final long serialVersionUID = -7111232249301645301L;
