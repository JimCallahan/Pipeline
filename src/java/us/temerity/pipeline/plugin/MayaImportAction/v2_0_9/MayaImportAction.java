// $Id: MayaImportAction.java,v 1.1 2007/06/17 15:34:43 jim Exp $
...
{  
  ...
  MayaImportAction() 
  {
    super("MayaImport", new VersionID("2.0.9"), "Temerity",
  ...
  private static final long serialVersionUID = -2546181443413065932L;
