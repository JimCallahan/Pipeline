// $Id: MayaImportAction.java,v 1.1 2007/06/19 18:24:50 jim Exp $
...
/** 
 * Generates a new Maya scene through importing component scenes.<P> 
 * 
...
{  
  ...
  MayaImportAction() 
  {
    super("MayaImport", new VersionID("2.0.11"), "Temerity",
    ...
    throws PipelineException
  {
	...
	if(!fseq.isSingle() || 
	  ...
	  throw new PipelineException
	    ("The MayaImport Action requires that the primary target file sequence " + 
  ...
  private static final long serialVersionUID = 7107626087593538368L;
