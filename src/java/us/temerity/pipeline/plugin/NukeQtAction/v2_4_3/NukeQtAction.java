// $Id: NukeQtAction.java,v 1.1 2008/03/19 15:13:32 jim Exp $
  ...
  extends NukeActionUtils
{
  ...
  NukeQtAction() 
  {
    super("NukeQt", new VersionID("2.4.3"), "Temerity", 
  ...
  private static final long serialVersionUID = 3046252249720343673L;
