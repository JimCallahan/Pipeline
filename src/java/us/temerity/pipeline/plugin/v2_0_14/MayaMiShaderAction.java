// $Id: MayaMiShaderAction.java,v 1.1 2006/07/04 06:12:29 jim Exp $

package us.temerity.pipeline.plugin.v2_0_14;
  ...
  extends BaseAction
{
  ...
  MayaMiShaderAction()
  {
    super("MayaMiShader", new VersionID("2.0.14"), "Temerity",
  ...
  { 
	...
	try {
      ...
      {
	Path apiJar = new Path(PackageInfo.sInstPath, "lib/api.jar");
	String utilClassPath = env.get("PIPELINE_UTIL_CLASSPATH");
	if(utilClassPath != null) 
	  classPath = (utilClassPath + ":" + apiJar.toOsString());
	else 
	  classPath = apiJar.toOsString();
      }
      
      javaCommand = 
	("java -cp " + classPath + " us.temerity.pipeline.utils.v2_0_14.MiRenderPrep " + 
	 "\"" + glueFile.getPath() + "\"");
  ...
  private static final long serialVersionUID = -756996643181733350L;
