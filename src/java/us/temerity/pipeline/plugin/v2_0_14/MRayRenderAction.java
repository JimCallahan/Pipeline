// $Id: MRayRenderAction.java,v 1.2 2006/11/22 09:08:01 jim Exp $
  ...
  extends BaseAction
{
  ...
  MRayRenderAction() 
  {
    super("MRayRender", new VersionID("2.0.14"), "Temerity", 
  ...
  { 
	...
	if(utilClassPath != null) 
      ...
      out.write("java -cp " + classPath
		+ " us.temerity.pipeline.utils.v2_0_14.MiRenderPrep \"" + glueFile.getPath()
		+ "\"\n");
  ...
  private static final long serialVersionUID = -4357762263546746060L;
