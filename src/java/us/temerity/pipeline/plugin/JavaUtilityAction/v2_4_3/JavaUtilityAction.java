// $Id: JavaUtilityAction.java,v 1.1 2008/08/07 22:17:56 jim Exp $
 ...
 * using the JavaBuild Action.  The class specified by Main Class must be derived 
  ...
  extends CommonActionUtils
{
  ...
  JavaUtilityAction() 
  {
    super("JavaUtility", new VersionID("2.4.3"), "Temerity", 
  ...
  { 
	...
	throw new PipelineException
      ...
      args.add("-Dpipeline.ostype=" + PackageInfo.sOsType);
      args.add("-Dpipeline.archtype=" + PackageInfo.sArchType);
      args.add("-Dpipeline.buildtype=" + PackageInfo.sBuildType); 
	...
	args.add(buf.toString());
      ...
      String program = PackageInfo.getJavaRuntime(PackageInfo.sOsType).toOsString();
  ...
  private static final long serialVersionUID = 121380801075416210L;
