// $Id: PREnvMapAction.java,v 1.1 2007/06/17 15:34:45 jim Exp $
...
{  
  ...
  PREnvMapAction() 
  {
    super("PREnvMap", new VersionID("2.0.0"), "Temerity", 
	  "Generate optimized PhotoRealistic RenderMan latitude/longitude environment maps " + 
	  "from source images.");
  ...
  private static final long serialVersionUID = -1382135790357055864L;
