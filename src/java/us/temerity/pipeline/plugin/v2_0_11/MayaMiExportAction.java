// $Id: MayaMiExportAction.java,v 1.1 2006/06/21 05:25:10 jim Exp $
...
{  
  ...
  MayaMiExportAction() 
  {
    super("MayaMiExport", new VersionID("2.0.11"), "Temerity",
  ...
  { 
	...
	if(sname != null) {
      ...
      {
	String str = (String) getSingleParamValue(PARAM_exportSet);
	...
	out.println("}");
	out.println("select -r \"" + exportSet + "\";");
  ...
  buildLayout()
  {
	...
	("Fragment Export",
	 ...
	 false);
      group.addEntry(PARAM_exportSet);
      group.addSeparator();
  ...
  private static final String PARAM_exportSet = "ExportSet";
  ...
  private static final long serialVersionUID = 199506752479535127L;
