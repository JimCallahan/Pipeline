...
/** 
 * Generates optimized Pixie textures from source TIFF images. <P> 
 * 
...
{  
  ...
  PxTextureAction() 
  {
    super("PxTexture", new VersionID("2.0.0"), "Temerity", 
	  "Generates optimized Pixie textures from source TIFF images.");
  ...
  private static final long serialVersionUID = -3356323997775124572L;
