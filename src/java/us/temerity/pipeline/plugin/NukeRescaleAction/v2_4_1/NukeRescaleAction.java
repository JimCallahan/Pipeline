// $Id: NukeRescaleAction.java,v 1.1 2008/02/04 12:09:57 jim Exp $
  ...
  extends NukeActionUtils
{
  ...
  NukeRescaleAction() 
  {
    super("NukeRescale", new VersionID("2.4.1"), "Temerity", 
  ...
  private static final long serialVersionUID = -5549649941735853259L;
