// $Id: MRayRenderGlobalsAction.java,v 1.1 2007/03/18 02:43:56 jim Exp $
...
{  
  ...
  private static final String aImageResolution          = "ImageResolution";
  private static final String aMinSampleLevel           = "MinSampleLevel";
  private static final String aMaxSampleLevel           = "MaxSampleLevel";
  private static final String aPixelFilterType          = "PixelFilterType";
  private static final String aPixelFilterWidthX        = "PixelFilterWidthX";
  private static final String aPixelFilterWidthY        = "PixelFilterWidthY";
  private static final String aRedThreshold             = "RedThreshold";
  private static final String aGreenThreshold           = "GreenThreshold";
  private static final String aBlueThreshold            = "BlueThreshold";
  private static final String aCoverageThreshold        = "CoverageThreshold";
  private static final String aSampleLock               = "SampleLock";
  private static final String aJitter                   = "Jitter";
  private static final String aUseRaytracing            = "UseRaytracing";
  private static final String aReflections              = "Reflections";
  private static final String aRefractions              = "Refractions";
  private static final String aMaxTraceDepth            = "MaxTraceDepth";
  private static final String aShadows                  = "Shadows";
  private static final String aScanline                 = "Scanline";
  private static final String aFaces                    = "Faces";
  private static final String aMotionBlur               = "MotionBlur";
  private static final String aMotionBlurBy             = "MotionBlurBy";
  private static final String aShutter                  = "Shutter";
  private static final String aShutterDelay             = "ShutterDelay";
  private static final String aTimeContrastRed          = "TimeContrastRed";
  private static final String aTimeContrastGreen        = "TimeContrastGreen";
  private static final String aTimeContrastBlue         = "TimeContrastBlue";
  private static final String aTimeContrastAlpha        = "TimeContrastAlpha";
  private static final String aMotionSteps              = "MotionSteps";
  private static final String aUseCaustics              = "UseCaustics";
  private static final String aCausticsAccuracy         = "CausticsAccuracy";
  private static final String aCausticsRadius           = "CausticsRadius";
  private static final String aCausticFilterType        = "CausticFilterType";
  private static final String aCausticFilterKernel      = "CausticFilterKernel";
  private static final String aUseGlobalIllum           = "UseGlobalIllum";
  private static final String aGlobalIllumAccuracy      = "GlobalIllumAccuracy";
  private static final String aGlobalIllumRadius        = "GlobalIllumRadius";
  private static final String aPhotonVolumeAccuracy     = "PhotonVolumeAccuracy";
  private static final String aPhotonVolumeRadius       = "PhotonVolumeRadius";
  private static final String aMaxReflectionPhotons     = "MaxReflectionPhotons";
  private static final String aMaxRefractionPhotons     = "MaxRefractionPhotons";
  private static final String aMaxPhotonDepth           = "MaxPhotonDepth";
  private static final String aPhotonMapFile            = "PhotonMapFile";
  private static final String aEnableGIMapVisualizer    = "EnableGIMapVisualizer";
  private static final String aPhotonMapRebuild         = "PhotonMapRebuild";
  private static final String aDirectIllumShadowEffects = "DirectIllumShadowEffects";
  private static final String aUseFinalGather           = "UseFinalGather";
  private static final String aPrecompPhotonLookup      = "PrecompPhotonLookup";
  private static final String aFinalGatherRays          = "FinalGatherRays";
  private static final String aMinRadius                = "MinRadius";
  private static final String aMaxRadius                = "MaxRadius";
  private static final String aFilter                   = "Filter";
  private static final String aFalloffStart             = "FalloffStart";
  private static final String aFalloffStop              = "FalloffStop";
  private static final String aTraceDepth               = "TraceDepth";
  private static final String aTraceReflection          = "TraceReflection";
  private static final String aTraceRefraction          = "TraceRefraction";
  private static final String aFinalGatherMapFile       = "FinalGatherMapFile";
  private static final String aEnableFGMapVisualizer    = "EnableFGMapVisualizer";
  private static final String aFinalGatherMapRebuild    = "FinalGatherMapRebuild";
  private static final String aPreviewFinalGather       = "PreviewFinalGather";
  private static final String aDataType                 = "DataType";
  private static final String aGamma                    = "Gamma";
  private static final String aColorClip                = "ColorClip";
  private static final String aInterpSamples            = "InterpSamples";
  private static final String aDesaturate               = "Desaturate";
  private static final String aPremultiply              = "Premultiply";
  private static final String aDither                   = "Dither";
  private static final String aAccelerationMethod       = "AccelerationMethod";
  private static final String aBspSize                  = "BspSize";
  private static final String aBspDepth                 = "BspDepth";
  private static final String aGridResolution           = "GridResolution";
  private static final String aGridMaxSize              = "GridMaxSize";
  private static final String aGridDepth                = "GridDepth";
  private static final String aTaskSize                 = "TaskSize";
  private static final String aPhysicalMemory           = "PhysicalMemory";
  private static final String aExportVerbosity          = "ExportVerbosity";
  private static final String aExportExactHierarchy     = "ExportExactHierarchy";
  private static final String aExportFullDagpath        = "ExportFullDagpath";
  private static final String aExportTexturesFirst      = "ExportTexturesFirst";
  private static final String aExportParticles          = "ExportParticles";
  private static final String aExportParticleInstances  = "ExportParticleInstances";
  private static final String aExportFluids             = "ExportFluids";
  private static final String aExportPostEffects        = "ExportPostEffects";
  private static final String aQuality                  = "Quality";
