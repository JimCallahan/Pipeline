// $Id: HfsIConvertAction.java,v 1.1 2007/06/17 15:34:41 jim Exp $
...
{  
  ...
  HfsIConvertAction() 
  {
    super("HfsIConvert", new VersionID("2.0.0"), "Temerity",
  ...
  private static final long serialVersionUID = -644564651744776802L;
