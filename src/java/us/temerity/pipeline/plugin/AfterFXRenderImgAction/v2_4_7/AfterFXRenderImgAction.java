  ...
  extends AfterFXActionUtils
{
  ...
  {
    super("AfterFXRenderImg", new VersionID("2.4.7"), "Temerity",
    ...
    throws PipelineException
  {
	...
	writeScriptToFile(out, preRenderScript);
      ...
      out.write(" var proj = app.project;\n" + 
      		...
      		" var projOffset = proj.displayStartFrame;\n" + 
      		" \n" + 
      		" var renderItem = null;\n" + 
      		" var frameDur = null;\n" +
      		" var compStart = null\n" + 
      ...
      out.write(" for (var i = 1; i <= items.length ; i++) {\n" + 
      		...
      		"           compStart = compItem.displayStartTime;\n" + 
      		" 	  }\n" + 
      		" 	} \n" + 
      		" 	else {\n" + 
      		" 	  item.render = false;\n" + 
      		...
      		"startFrame = startFrame - projOffset;\n" + 
      		"endFrame = endFrame - projOffset;\n" + 
      		"renderItem.timeSpanStart = frameDur * startFrame - compStart ;\n" + 
  ...
  private static final long serialVersionUID = 6751249206119919368L;
