// $Id: IVEditor.java,v 1.1 2007/06/17 15:34:41 jim Exp $
...
{  
  ...
  IVEditor()
  {
    super("IV", new VersionID("2.0.9"), "Temerity",
	  "Displays images using the Gelato display server.", 
	  "iv");  
  ...
  private static final long serialVersionUID = -5272644655991022048L;
