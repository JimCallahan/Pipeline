// $Id: MayaRenderAction.java,v 1.3 2008/05/10 21:53:33 jim Exp $
  ...
  extends MayaActionUtils
{
  ...
  MayaRenderAction()
  {
    super("MayaRender", new VersionID("2.3.10"), "Temerity",
  ...
  private static final long serialVersionUID = -4182839102986900832L;
  ...
  public static final String aTargetDir      = "TargetDir";
  public static final String aParentDir      = "ParentDir";
  public static final String aSceneDir       = "SceneDir";
  public static final String aSceneParentDir = "SceneParentDir";
  public static final String aNoProject      = "NoProject";
  public static final String aCustomDir      = "CustomDir";
