// $Id: MayaRenderAction.java,v 1.1 2007/07/30 17:42:05 jesse Exp $
  ...
  extends MayaActionUtils
{
  ...
  MayaRenderAction()
  {
    super("MayaRender", new VersionID("2.3.2"), "Temerity",
...
//      /String renderer = (String) getSingleParamValue(aRenderer);
	...
	throw new PipelineException("Unsupported Renderer type!");
      ...
      {
	if (renderLayer != null) {
	  String topPathDir = renderPath.getName();
  ...
  private static final long serialVersionUID = -3300748817694685233L;
