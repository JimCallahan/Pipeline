...
package us.temerity.pipeline.plugin.MayaRenderAction.v2_4_28;
  ...
  extends MayaActionUtils
{
  ...
  MayaRenderAction()
  {
    super("MayaRender", new VersionID("2.4.28"), "Temerity",
...

    {
      ...
      layout.addEntry(aMayaWorkspace);
      layout.addSeparator();
    ...
    throws PipelineException
  {
    ...
    ArrayList<String> args = new ArrayList<String>();
    {
      ...
      {
        Path projectPath = 
          getPrimarySourcePath(aMayaWorkspace, agenda, "mel", "workspace.mel file");
        if (projectPath != null) {
          String name = projectPath.getName();
          if (!name.equals("workspace.mel"))
            throw new PipelineException
              ("The MayaWorkspace Parameter must be a mel file named (workspace.mel)");
          args.add("-proj");
          args.add(projectPath.getParentPath().toOsString());
        }
      }
  ...
  private static final long serialVersionUID = -8328329344780318731L;
  
  public static final String aCameraOverride = "CameraOverride";
  public static final String aRenderLayer    = "RenderLayer";
  public static final String aMayaWorkspace  = "MayaWorkspace";
