// $Id: CatSequenceAction.java,v 1.1 2009/03/14 22:08:19 jim Exp $
...
{  
  ...
  CatSequenceAction() 
  {
    super("CatSequence", new VersionID("2.0.1"), "Temerity", 
  ...
  { 
	...
	for(Integer order : sources.keySet()) {
	  ...
	  for(String sname : sources.get(order)) {
		...
		out.write("cp --force " + source + " " + target + "\n");
	      }
  ...
  private static final long serialVersionUID = -7248701644924253758L;
