  ...
  extends BaseAction
{
    ...
    throws PipelineException
  {
    ...
    {
	String sname = (String) getSingleParamValue(PARAM_preExportMEL); 
	if(sname != null) {
	  FileSeq fseq = agenda.getPrimarySource(sname);
	  if(fseq == null) 
	    throw new PipelineException
    ...
    {
	String sname = (String) getSingleParamValue(PARAM_postExportMEL); 
	if(sname != null) {
	  FileSeq fseq = agenda.getPrimarySource(sname);
	  if(fseq == null) 
	    throw new PipelineException
	...
	buf.append(arg + " ");
      ...
      String extraOpts = (String) getSingleParamValue(PARAM_extraOpts);
      if (extraOpts != null)
    ...
    private static final String PARAM_preExportMEL = "PreExportMEL";
    private static final String PARAM_postExportMEL = "PostExportMEL";
    private static final String PARAM_extraOpts = "ExtraOptions";
