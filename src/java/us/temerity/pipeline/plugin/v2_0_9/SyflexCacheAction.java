...
public class SyflexCacheAction extends BaseAction
{
   ...
   {
      super("SyflexCache", new VersionID("2.0.9"), "Temerity", "Creates a syflex cache");
     ...
     throws PipelineException
   {
      ...
      
      {
		  ...
		  cachePath = ("$WORKING" + p.getParent() + "/" + fseq.getFilePattern().getPrefix() + "." );
      ...
      try {
        ...
        out.println("		 print (\"frame \" + $frame + \" took syflex \" + ($sy_roundTime) + \" seconds.\\n\");");
        out.println("}");
