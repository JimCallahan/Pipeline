// $Id: ImgCvtAction.java,v 1.1 2006/05/30 17:19:17 jim Exp $
...
{  
  ...
  ImgCvtAction() 
  {
    super("ImgCvt", new VersionID("2.0.9"), "Temerity",
    ...
    throws PipelineException
  {
	...
	fromPath = new Path(PackageInfo.sProdPath, 
  ...
  private static final long serialVersionUID = 373766045484555027L;
