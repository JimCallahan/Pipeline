// $Id: MayaRenderGlobalsAction.java,v 1.1 2006/05/26 17:06:35 jim Exp $
...
{  
  ...
  {
    super("MayaRenderGlobals", new VersionID("2.0.9"), "Temerity",
  ...
  { 
    ...
    try {      
      ...
      out.write("cat > " + target.toOsString() + " <<EOF\n" +
  ...
  private static final long serialVersionUID = 888415834541751127L;
