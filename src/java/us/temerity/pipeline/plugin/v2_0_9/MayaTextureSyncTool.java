// $Id: MayaTextureSyncTool.java,v 1.7 2007/01/16 00:21:23 jim Exp $
...
{  
  ...
  MayaTextureSyncTool()
  {
    super("MayaTextureSync", new VersionID("2.0.9"), "Temerity",
  ...
  {    
	...
	SubProcessLight proc = 
	  new SubProcessLight("MayaTextureSync-FileInfo", "maya", args, env, wpath.toFile());
	try {
	  proc.start();
	  proc.join();
  ...
  private static final long serialVersionUID = -1938310428741290204L;
