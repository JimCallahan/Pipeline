// $Id: CatSequenceAction.java,v 1.3 2005/09/07 19:17:08 jim Exp $
...
{  
  ...
  CatSequenceAction() 
  {
    super("CatSequence", new VersionID("1.0.0"), "Temerity", 
  ...
  private static final long serialVersionUID = -1335381504997290655L;
