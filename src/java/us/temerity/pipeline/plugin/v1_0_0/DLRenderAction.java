// $Id: DLRenderAction.java,v 1.1 2005/05/11 11:23:29 jim Exp $
 ...
 * images, depthmaps or deep shadow maps may be generated in one rendering pass. See the 
...
{  
  ...
  DLRenderAction() 
  {
    super("DLRender", new VersionID("1.0.0"), 
