// $Id: AirTextureAction.java,v 1.4 2006/11/22 09:08:01 jim Exp $
...
/*------------------------------------------------------------------------------------------*/
/*   A I R   T E X T U R E   A C T I O N                                                    */
/*------------------------------------------------------------------------------------------*/
 ...
 *   Rotate <BR>
 *   <DIV style="margin-left: 40px;">
 *     Rotate the output texture map the given angle. <BR>
 *   </DIV> <BR>
 * 
 *   Tile Size <BR>
 *   <DIV style="margin-left: 40px;">
...
{  
  ...
  AirTextureAction() 
  {
	...
	new EnumActionParam
	("Rotate", 
	 "Rotate the output texture map the given angle.", 
	 "None", choices);
      addSingleParam(param);
    }   
  ...
  private static final long serialVersionUID = 7103352450701603412L;
