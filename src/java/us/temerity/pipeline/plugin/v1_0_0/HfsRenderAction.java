// $Id: HfsRenderAction.java,v 1.1 2005/06/28 20:51:10 jim Exp $
 ...
 * sequence should contain the images to be rendered.  The frame range (trange f1 f2 f3),
...
{  
  ...
  { 
	...
	if(sname != null) {
	  ...
	  if(!fseq.isSingle() || (suffix == null) || !suffix.equals("hip")) 
	    throw new PipelineException
	      ("The HoudiniRender Action requires that the source node specified by the " + 
	...
	if(sname != null) {
	  ...
	  if(!fseq.isSingle() || (suffix == null) || !(suffix.equals("cmd"))) 
	    throw new PipelineException
	      ("The HfsFrame Action requires that the source node specified by the Pre " +
	...
	if(sname != null) {
	  ...
	  if(!fseq.isSingle() || (suffix == null) || !(suffix.equals("cmd"))) 
	    throw new PipelineException
	      ("The HfsFrame Action requires that the source node specified by the Post " +
	       "Frame Script parameter (" + sname + ") must have a single command script " + 
	       "as its primary file sequence!");
  ...
  private static final long serialVersionUID = -7575391384566344524L;
