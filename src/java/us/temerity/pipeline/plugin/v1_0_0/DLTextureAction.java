// $Id: DLTextureAction.java,v 1.5 2006/11/22 09:08:01 jim Exp $
...
{  
  ...
  DLTextureAction() 
  {
    super("DLTexture", new VersionID("1.0.0"), "Temerity", 
	  "Generates optimized 3Delight textures from source images.");
  ...
  private static final long serialVersionUID = 2505153051306703984L;
