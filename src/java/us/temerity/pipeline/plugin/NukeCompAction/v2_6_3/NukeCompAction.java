...
package us.temerity.pipeline.plugin.NukeCompAction.v2_6_3;
...
{  
  ...
  NukeCompAction() 
  {
    super("NukeComp", new VersionID("2.6.3"), "Temerity",
  ...
  private static final long serialVersionUID = -7680758035280227176L;
