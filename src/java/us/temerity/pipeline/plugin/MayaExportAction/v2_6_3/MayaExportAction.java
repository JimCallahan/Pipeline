package us.temerity.pipeline.plugin.MayaExportAction.v2_6_3;
  ...
  extends MayaActionUtils
{
  ...
  MayaExportAction()
  {
    super("MayaExport", new VersionID("2.6.3"), "Temerity",
    ...
    
    {
      ActionParam param = 
      	new BooleanActionParam
      	(aExportShaders,
      	 "Should shader information be exported.", 
      	 true); 
      addSingleParam(param);
    }
  ...
  { 
    ...
    int exportShaders     = getSingleBooleanParamValue(aExportShaders) ? 1 : 0;
  ...
  public static final String aExportShaders      = "ExportShaders";
  public static final String aExportConstraints  = "ExportConstraints";

  private static final long serialVersionUID = 620681795000710994L;
}
