// $Id: MayaReferenceAction.java,v 1.1 2007/06/17 15:34:44 jim Exp $
...
{  
  ...
  MayaReferenceAction() 
  {
    super("MayaReference", new VersionID("2.0.0"), "Temerity",
    ...
    throws PipelineException
  {
	...
	String param = (String) getSourceParamValue(mname, "PrefixName");
  ...
  private static final long serialVersionUID = -7261752388880324338L;
