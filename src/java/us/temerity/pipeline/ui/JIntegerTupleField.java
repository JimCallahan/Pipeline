// $Id: JIntegerTupleField.java,v 1.1 2007/07/31 14:58:40 jim Exp $
...
/*------------------------------------------------------------------------------------------*/
/*   I N T E G E R   T U P L E   F I E L D                                                  */
/*------------------------------------------------------------------------------------------*/

/**
 * A field which represents a Tuple*i value.
 */
public 
class JIntegerTupleField
  extends JPanel
  implements ActionListener
{
  ...
  {
    super();  
    setName("JIntegerField");

    setAlignmentY(0.5f);
    setLayout(new BoxLayout(this, BoxLayout.X_AXIS));

    pSize = size; 
    pFields = new JIntegerField[pSize];
    ...
    for(i=0; i<pSize; i++) {
      ...
      pFields[i] = UIFactory.createIntegerField(0, 35, JLabel.CENTER);
  ...
  private static final long serialVersionUID = -3187758451109240738L;
   ...
   */ 
  protected JIntegerField[]  pFields; 
