   ...
   implements FontGeometry
{
  ...
  private static final Point3d sOrigin[] = {
    ...
    new Point3d(0.05, 0, 0.0),
    new Point3d(0, 0, 0.0),
    new Point3d(0.04999999999, -0.2, 0.0),
    new Point3d(0.05, 0, 0.0),
    new Point3d(0.05, 0, 0.0),
    new Point3d(-0.05, -0.2, 0.0),
    new Point3d(0.05, 0, 0.0),
    ...
    new Point3d(0.05, -0.2, 0.0),
    new Point3d(0.05, 0, 0.0),
    new Point3d(0.05, -0.001009831125, 0.0),
    new Point3d(0, 0, 0.0),
    new Point3d(0.05, 0, 0.0),
    new Point3d(0.025, 0, 0.0),
    new Point3d(0, 0, 0.0),
    new Point3d(0.025, 0, 0.0),
    new Point3d(-0.0125, -0.2, 0.0),
    new Point3d(0.05, 0, 0.0),
    new Point3d(0.05, -0.2, 0.0),
    new Point3d(0.05, -0.2, 0.0),
    new Point3d(0, -0.2, 0.0),
  ...
  private static final Vector3d sExtent[] = {
    ...
    null,
    null,
    new Vector3d(0.25078125, 0.65, 0.0),
    null,
    null,
    null,
    null,
    new Vector3d(0.15, 0.65, 0.0),
    ...
    new Vector3d(0.4, 0.5022599851, 0.0),
    new Vector3d(0.3, 0.65, 0.0),
    new Vector3d(0.45, 0.5, 0.0),
    new Vector3d(0.5, 0.5, 0.0),
    new Vector3d(0.75, 0.5, 0.0),
    new Vector3d(0.5, 0.5, 0.0),
    new Vector3d(0.575, 0.7, 0.0),
