// $Id: JCheckOutDialog.java,v 1.1 2005/01/03 06:56:24 jim Exp $
  ...
  extends JBaseDialog
{
  ...
  JCheckOutDialog() 
  {
...

	{
	  ...
	  pVersionField = 
	    UIFactory.createTitledCollectionField(tpanel, "Check-Out Version:", sTSize, 
	...
	pModeField = 
	  UIFactory.createTitledCollectionField(tpanel, "Check-Out Mode:", sTSize, 
	...
	pMethodField = 
	  UIFactory.createTitledCollectionField(tpanel, "Check-Out Method:", sTSize, 
