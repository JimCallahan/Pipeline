// $Id: JBaseJobReqsDialog.java,v 1.1 2009/10/07 08:09:50 jim Exp $
...
/*------------------------------------------------------------------------------------------*/
/*   B A S E   J O B   R E Q S   D I A L O G                                                */
/*------------------------------------------------------------------------------------------*/

/**
 * Common base class for dialogs which specify job requirements.
 */ 
public 
class JBaseJobReqsDialog
  extends JFullDialog
  implements ComponentListener
{
   ...
   *   
   * @param includeBatchSize
   *   Whether to include components to set the job batch size.
   */ 
  protected 
  JBaseJobReqsDialog
  (
   Frame owner,
   String title,
   boolean includeBatchSize
  )  
  {
    super(owner, title);
    
    pIncludeBatchSize = includeBatchSize;
  ...
  protected static final int sVSize = 250;
   ...
   * Whether to include components to set the job batch size.
   */ 
  private boolean pIncludeBatchSize;
