// $Id: JToolsetToolPluginsPanel.java,v 1.4 2006/01/15 06:29:26 jim Exp $
  ...
  extends JBaseToolsetPluginsPanel
{
    ...
    throws PipelineException
  {
	...
	DoubleMap<String,String,TreeSet<VersionID>> table = 
	  pDialog.getPackageTools(pname, os, pvid);
    ...
    throws PipelineException
  {
    ...
    PluginMenuLayout layout = client.getToolMenuLayout(pToolsetOsType);
    ...
    throws PipelineException
  {
    UIMaster master = UIMaster.getInstance();
    MasterMgrClient client = master.getMasterMgrClient();
    client.setToolMenuLayout(pToolsetOsType, getLayout(pToolsetName, pToolsetOsType));
  }
  ...
  (
   ...
   OsType os
    ...
    throws PipelineException
  {
    return pDialog.getToolsetTools(tname, os);
  }
  ...
  (
   ...
   PluginMenuLayout layout
    ...
    throws PipelineException
  {
    pDialog.setToolsetTools(tname, os, layout);
  }
