// $Id: JNewSuffixDialog.java,v 1.1 2004/06/08 03:06:36 jim Exp $
  ...
  implements DocumentListener
{
  ...
  )
  {
    ...
    /* create dialog body components */ 
    {
      ...
      body.add(UIMaster.createPanelLabel("New Filename Suffix:"));
      
      body.add(Box.createRigidArea(new Dimension(0, 4)));
      
      {
	JAlphaNumField field = UIMaster.createAlphaNumField(null, 60, JLabel.LEFT);
	pSuffixField = field;
