// $Id: JNodeIdentifierField.java,v 1.3 2009/06/04 09:26:58 jim Exp $
 ...
 * '<CODE>0</CODE>'-'<CODE>9</CODE>', '<CODE>_</CODE>', '<CODE>-</CODE>', '<CODE>~</CODE>' <P>
 */ 
public 
  ...
  extends JTextField 
{
    ...
    extends PlainDocument 
  {
	...
	return;
      ...
      if(!Identifiers.hasIdentChars(str)) {
