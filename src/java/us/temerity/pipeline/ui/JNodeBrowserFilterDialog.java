// $Id: JNodeBrowserFilterDialog.java,v 1.1 2004/10/24 03:52:03 jim Exp $
  ...
  extends JBaseDialog
{
  ...
  )
  {
...

	{
	  {
	    JLabel label = 
	      UIMaster.createFixedLabel("Working Versions:", sTSize, JLabel.CENTER);
	  ...
	  {
	    JLabel label = 
	      UIMaster.createFixedLabel("Checked-In Versions:", sTSize, JLabel.CENTER);
	    label.setName("PanelLabel");
	  ...
	  {
	    JLabel label = 
	      UIMaster.createFixedLabel("Show Nodes?", sVSize, JLabel.CENTER);
	    label.setName("PanelLabel");
  ...
  {
    tpanel1.add(UIMaster.createFixedLabel(label1, sTSize, JLabel.CENTER));
    tpanel2.add(UIMaster.createFixedLabel(label2, sTSize, JLabel.CENTER));
