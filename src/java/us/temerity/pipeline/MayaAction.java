// $Id: MayaAction.java,v 1.1 2007/03/18 02:42:51 jim Exp $
...
{  
    ...
    throws PipelineException 
  {
    ...
    return getSinglePrimaryTargetPath(agenda, suffixes, "Maya scene file");
  }
  ...
  (
   ...
   ActionAgenda agenda
    ...
    throws PipelineException 
  {
    return getSinglePrimarySourcePath(pname, agenda, "mel", "MEL script");
  }
    ...
    throws PipelineException 
  {
    ...
    return getSinglePrimarySourcePath(pname, agenda, suffixes, "Maya scene file");
  }
  ...
  {  
    ...
    if(midefs != null) {
      ...
      Path dpath = getWorkingNodeFilePath(agenda.getNodeID(), midefs);
    ...
    throws PipelineException
  {
    ...
    buf.append(" -batch -script \"" + script + "\"");
