// $Id: GenerateException.java,v 1.1 2009/04/07 06:01:20 jim Exp $

/*------------------------------------------------------------------------------------------*/
/*   G E N E R A T E   E X C E P T I O N                                                    */
/*------------------------------------------------------------------------------------------*/

/**
 * Indicates an exceptional case encountered during Java code generation.
 */
public
  ...
  extends Exception 
{
   ...
   *   
   *  @return
   *    A Generate Exception that contains a detailed message about why the cause was thrown
   *    including a stack trace.
   */
  public static GenerateException
  ...
  )
  {
    ...
    return new GenerateException(buf.toString(), cause);
  }
  ...
  private static final long serialVersionUID = 6681276822914743587L;
