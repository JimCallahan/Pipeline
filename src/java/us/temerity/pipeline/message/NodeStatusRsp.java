// $Id: NodeStatusRsp.java,v 1.1 2004/04/11 19:31:31 jim Exp $
  ...
  extends TimedRsp
{
  ...
  { 
    ...
    if(status == null) 
      throw new IllegalArgumentException("The overall node status cannot be (null)!");
    pNodeStatus = status;    
