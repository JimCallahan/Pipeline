...
/*------------------------------------------------------------------------------------------*/
/*   Q U E U E   G E T   S E L E C T I O N   S C H E D U L E   N A M E S   R S P            */
/*------------------------------------------------------------------------------------------*/
 ...
 */
public
class QueueGetSelectionScheduleNamesRsp
  extends TimedRsp
{
  /*----------------------------------------------------------------------------------------*/
   ...
   * 
   * @param names
   *   The selection schedules names. 
   */ 
  public
  QueueGetSelectionScheduleNamesRsp
  (
   TaskTimer timer, 
  ...
  /**
   * Gets the selection schedule names.
   */
  ...
  private static final long serialVersionUID = 6535416053822853668L;
