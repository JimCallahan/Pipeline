 ...
 * {@link QueueGetUnfinishedJobsForNodesReq QueueGetUnfinishedJobsForNodesReq} request.
 */
public
class QueueGetUnfinishedJobsForNodesRsp
  extends TimedRsp
{
  /*----------------------------------------------------------------------------------------*/
   ...
   */ 
  public
  QueueGetUnfinishedJobsForNodesRsp
  (
   TaskTimer timer, 
