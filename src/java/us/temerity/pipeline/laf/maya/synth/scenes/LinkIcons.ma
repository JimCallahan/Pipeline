...
//Name: LinkIcons.ma
//Last modified: Mon, May 17, 2004 01:37:56 AM
requires maya "5.0";
...
createNode transform -n "persp1";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 0.18617809918086975 2.6031444686441993 1.0688686956764544 ;
...
createNode transform -n "group3";
	setAttr ".v" no;
	setAttr ".r" -type "double3" 0 37.079045163092758 0 ;
...
createNode surfaceShader -n "surfaceShader1";
	setAttr ".oc" -type "float3" 0.80000001 0.80000001 0.80000001 ;
...
createNode trim -n "trim3";
	setAttr -s 12 ".ic";
	setAttr -s 5 ".lu[0:4]"  0.66701817107778782 0.58342718924651527 0.33432606338932325 
		0.4797743717757374 0.10027131426176025;
	setAttr -s 5 ".lv[0:4]"  0.4862409537405713 0.49460005192369855 0.48289731446732043 
		0.26221712243276102 0.55645737847884025;
...
createNode trim -n "trim5";
	setAttr -s 20 ".ic";
	setAttr -s 12 ".lu[0:11]"  0.90441655947860156 0.6703618103510387 0.58342718924651527 
		0.60516084452264618 0.41791704522059575 0.32429514556957051 0.33599788302594868 
		0.41122976667409394 0.44299433976997749 0.67537726926091501 0.56670899288026078 
		0.48813346995886464;
	setAttr -s 12 ".lv[0:11]"  0.50295915010682579 0.36921357917678982 0.37924449699654256 
		0.42438362718542966 0.43943000391505871 0.36921357917678982 0.62500198358048364 
		0.56816011593521831 0.62667380321710908 0.62667380321710908 0.55645737847884025 
		0.50463096974345123;
...
connectAttr "trim3.os" "nurbsPlaneShape6.cr";
...
connectAttr "trim5.os" "nurbsPlaneShape7.cr";
...
connectAttr "|OneToOne|nurbsPlane6|nurbsPlaneShape6->|projectionCurve37|projectionCurve37_1|projectionCurve37_Shape1.ws" "trim3.ic[0]"
		;
connectAttr "|OneToOne|nurbsPlane6|nurbsPlaneShape6->|projectionCurve38|projectionCurve38_1|projectionCurve38_Shape1.ws" "trim3.ic[1]"
		;
connectAttr "|OneToOne|nurbsPlane6|nurbsPlaneShape6->|projectionCurve39|projectionCurve39_1|projectionCurve39_Shape1.ws" "trim3.ic[2]"
		;
connectAttr "|OneToOne|nurbsPlane6|nurbsPlaneShape6->|projectionCurve40|projectionCurve40_1|projectionCurve40_Shape1.ws" "trim3.ic[3]"
		;
connectAttr "|OneToOne|nurbsPlane6|nurbsPlaneShape6->|projectionCurve41|projectionCurve41_1|projectionCurve41_Shape1.ws" "trim3.ic[4]"
		;
connectAttr "|OneToOne|nurbsPlane6|nurbsPlaneShape6->|projectionCurve42|projectionCurve42_1|projectionCurve42_Shape1.ws" "trim3.ic[5]"
		;
connectAttr "|OneToOne|nurbsPlane6|nurbsPlaneShape6->|projectionCurve43|projectionCurve43_1|projectionCurve43_Shape1.ws" "trim3.ic[6]"
		;
connectAttr "|OneToOne|nurbsPlane6|nurbsPlaneShape6->|projectionCurve44|projectionCurve44_1|projectionCurve44_Shape1.ws" "trim3.ic[7]"
		;
connectAttr "|OneToOne|nurbsPlane6|nurbsPlaneShape6->|projectionCurve45|projectionCurve45_1|projectionCurve45_Shape1.ws" "trim3.ic[8]"
		;
connectAttr "|OneToOne|nurbsPlane6|nurbsPlaneShape6->|projectionCurve46|projectionCurve46_1|projectionCurve46_Shape1.ws" "trim3.ic[9]"
		;
connectAttr "|OneToOne|nurbsPlane6|nurbsPlaneShape6->|projectionCurve47|projectionCurve47_1|projectionCurve47_Shape1.ws" "trim3.ic[10]"
		;
connectAttr "|OneToOne|nurbsPlane6|nurbsPlaneShape6->|projectionCurve48|projectionCurve48_1|projectionCurve48_Shape1.ws" "trim3.ic[11]"
		;
connectAttr "nurbsPlaneShape6Original.l" "trim3.is";
...
connectAttr "|All|nurbsPlane7|nurbsPlaneShape7->|projectionCurve1|projectionCurve1_1|projectionCurve1_Shape1.ws" "trim5.ic[0]"
		;
connectAttr "|All|nurbsPlane7|nurbsPlaneShape7->|projectionCurve2|projectionCurve2_1|projectionCurve2_Shape1.ws" "trim5.ic[1]"
		;
connectAttr "|All|nurbsPlane7|nurbsPlaneShape7->|projectionCurve3|projectionCurve3_1|projectionCurve3_Shape1.ws" "trim5.ic[2]"
		;
connectAttr "|All|nurbsPlane7|nurbsPlaneShape7->|projectionCurve4|projectionCurve4_1|projectionCurve4_Shape1.ws" "trim5.ic[3]"
		;
connectAttr "|All|nurbsPlane7|nurbsPlaneShape7->|projectionCurve5|projectionCurve5_1|projectionCurve5_Shape1.ws" "trim5.ic[4]"
		;
connectAttr "|All|nurbsPlane7|nurbsPlaneShape7->|projectionCurve6|projectionCurve6_1|projectionCurve6_Shape1.ws" "trim5.ic[5]"
		;
connectAttr "|All|nurbsPlane7|nurbsPlaneShape7->|projectionCurve7|projectionCurve7_1|projectionCurve7_Shape1.ws" "trim5.ic[6]"
		;
connectAttr "|All|nurbsPlane7|nurbsPlaneShape7->|projectionCurve8|projectionCurve8_1|projectionCurve8_Shape1.ws" "trim5.ic[7]"
		;
connectAttr "|All|nurbsPlane7|nurbsPlaneShape7->|projectionCurve9|projectionCurve9_1|projectionCurve9_Shape1.ws" "trim5.ic[8]"
		;
connectAttr "|All|nurbsPlane7|nurbsPlaneShape7->|projectionCurve10|projectionCurve10_1|projectionCurve10_Shape1.ws" "trim5.ic[9]"
		;
connectAttr "|All|nurbsPlane7|nurbsPlaneShape7->|projectionCurve11|projectionCurve11_1|projectionCurve11_Shape1.ws" "trim5.ic[10]"
		;
connectAttr "|All|nurbsPlane7|nurbsPlaneShape7->|projectionCurve12|projectionCurve12_1|projectionCurve12_Shape1.ws" "trim5.ic[11]"
		;
connectAttr "|All|nurbsPlane7|nurbsPlaneShape7->|projectionCurve13|projectionCurve13_1|projectionCurve13_Shape1.ws" "trim5.ic[12]"
		;
connectAttr "|All|nurbsPlane7|nurbsPlaneShape7->|projectionCurve14|projectionCurve14_1|projectionCurve14_Shape1.ws" "trim5.ic[13]"
		;
connectAttr "|All|nurbsPlane7|nurbsPlaneShape7->|projectionCurve15|projectionCurve15_1|projectionCurve15_Shape1.ws" "trim5.ic[14]"
		;
connectAttr "|All|nurbsPlane7|nurbsPlaneShape7->|projectionCurve16|projectionCurve16_1|projectionCurve16_Shape1.ws" "trim5.ic[15]"
		;
connectAttr "|All|nurbsPlane7|nurbsPlaneShape7->|projectionCurve17|projectionCurve17_1|projectionCurve17_Shape1.ws" "trim5.ic[16]"
		;
connectAttr "|All|nurbsPlane7|nurbsPlaneShape7->|projectionCurve18|projectionCurve18_1|projectionCurve18_Shape1.ws" "trim5.ic[17]"
		;
connectAttr "|All|nurbsPlane7|nurbsPlaneShape7->|projectionCurve19|projectionCurve19_1|projectionCurve19_Shape1.ws" "trim5.ic[18]"
		;
connectAttr "|All|nurbsPlane7|nurbsPlaneShape7->|projectionCurve20|projectionCurve20_1|projectionCurve20_Shape1.ws" "trim5.ic[19]"
		;
connectAttr "nurbsPlaneShape7Original.l" "trim5.is";
...
connectAttr "nurbsPlane4trimmedSurfaceShape1.iog" "surfaceShader2SG.dsm"
		 -na;
connectAttr "nurbsPlane3trimmedSurfaceShape1.iog" "surfaceShader2SG.dsm"
		 -na;
connectAttr "nurbsPlane1trimmedSurfaceShape1.iog" "surfaceShader2SG.dsm"
		 -na;
