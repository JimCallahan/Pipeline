...
//Name: NormalFrozen.ma
//Last modified: Wed, Oct 12, 2005 04:39:08 PM
...
createNode reference -n "NormalRN";
	setAttr -s 20 ".phl";
	setAttr ".phl[0]" -type "TdataCompound" ;
	...
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		"NormalRN" 0
		"NormalRN" 35
		2 "Normal_select" "color" " -type \"float3\" 1 1 1"
		...
		5 3 "NormalRN" "|Normal_ADDED|Normal_inset|Normal_insetShape.instObjGroups" "NormalRN.placeHolderList[7]" 
		...
		"Normal_lambert3SG.dagSetMembers" "NormalRN.placeHolderList[14]" "NormalRN.placeHolderList[15]" 
		"Normal_lambert3SG.dsm"
		5 0 "NormalRN" "|Normal_COLLAPSED|Normal_nurbsSphere2|Normal_nurbsSphereShape2.instObjGroups" 
		"Normal_lambert3SG.dagSetMembers" "NormalRN.placeHolderList[16]" "NormalRN.placeHolderList[17]" 
		"Normal_lambert3SG.dsm"
		5 0 "NormalRN" "|Normal_COLLAPSED|Normal_nurbsSphere1|Normal_nurbsSphereShape1.instObjGroups" 
		"Normal_lambert3SG.dagSetMembers" "NormalRN.placeHolderList[18]" "NormalRN.placeHolderList[19]" 
		"Normal_lambert3SG.dsm";
...
connectAttr "NormalRN.phl[0]" "whiteSG.dsm" -na;
connectAttr "NormalRN.phl[1]" "whiteSG.dsm" -na;
connectAttr "NormalRN.phl[2]" "whiteSG.dsm" -na;
connectAttr "NormalRN.phl[3]" "whiteSG.dsm" -na;
connectAttr "NormalRN.phl[4]" "whiteSG.dsm" -na;
connectAttr "NormalRN.phl[5]" "whiteSG.dsm" -na;
...
connectAttr "NormalRN.phl[14]" "NormalRN.phl[15]";
connectAttr "NormalRN.phl[16]" "NormalRN.phl[17]";
connectAttr "NormalRN.phl[18]" "NormalRN.phl[19]";
