// $Id: DisneyBuild.java,v 1.1 2009/05/23 04:47:35 jesse Exp $
...
public class DisneyBuild
{
    ...
    String[] args)
  {
    ...
    for (int i = 0; i < iters; i++) {
      ...
      replacements.put("PROJECT", "disney");
      ...
      FrameRange range = new FrameRange(1, random(50, 400), 1);
    ...
    run()
    {
      ...
      try {
        TemplateBuilder builder = 
          new TemplateBuilder(mclient, qclient, information, pTemplateInfo, pStringReplacements, pContexts, pFrameRanges, pAoeModes);
        builder.run();
      }
