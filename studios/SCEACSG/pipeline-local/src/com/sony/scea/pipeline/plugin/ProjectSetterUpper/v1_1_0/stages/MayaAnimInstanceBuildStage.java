...
public 
class MayaAnimInstanceBuildStage 
  extends MayaFileStage
{
  public MayaAnimInstanceBuildStage
  (
    String name,
    String desc,
    ...
    throws PipelineException
  {
    super(name, 
          ...
          isAscii, 
          null, 
          new PluginContext("MayaAnimInstanceBuild", "SCEA"));
    setUnits();
  }
    ...
    throws PipelineException
  {
    ...
    if (numInstances > 1)
    {
    	addSourceParamValue(sourceName, "NumInstances", numInstances);
    }
    
    if (instanceStart > 0)
    {
    	addSourceParamValue(sourceName, "InstanceStart", instanceStart);
    }
