// $Id: ShakeQuickTimeAction.java,v 1.1 2008/06/11 12:48:23 jim Exp $

package com.sony.scea.pipeline.plugin.ShakeQuickTimeAction.v1_3_0;
...
public
  ShakeQuickTimeAction() 
  {
    super("ShakeQuickTime", new VersionID("1.3.0"), "SCEA",
  ...
  { 
    /* write the temp Shake script to evaluate */
      ...
      if(fseq == null) 
	    ...
	    try {      
	      ...
	      out.println("");
	      out.println("");
	      out.println("SetTimeRange(\""+sourceSeq.getFrameRange().getStart()+"-"+sourceSeq.getFrameRange().getEnd()+"\");");
	      ...
	      out.println("");
	      out.println("seq001_004_lgt_test_render = SFileIn(\"" + new Path(PackageInfo.sProdPath, sNodeID.getWorkingParent()).toString() + "/" + sourceSeq.getFilePattern().getPrefix() +"."+ sourceSeq.getFrameRange().getStart() +"-"+sourceSeq.getFrameRange().getEnd()+"x"+sourceSeq.getFrameRange().getBy()+"#." + sourceSeq.getFilePattern().getSuffix() + "\", ");
	      ...
	      out.println("random = FileOut(Resize1, \"" + new Path(PackageInfo.sProdPath, agenda.getNodeID().getWorkingParent() + "/" + fseq.getPath(0)) + "\", ");
	      out.println("    \"QuickTime\", \"Shake 3 QT 1\", \"H.264\", 0, \"100W@c6000WDcsuHpoe10pFnKA6W230PPMMRH#0LgfI5ALV1EaKGn3DG32X8RMYL03SeOBPg00K1bYAESoHW0KAbabF7YWOQan8401v6QvQehFnRYIBt9be1B4AEjYA6ci8YmM#IKXCg5aRMZC2MXBM0Ani04wHAJLmBrQ97MtegeEEO9d5oBAvCgv520Ai8E97IBbzlkfGjeKAoGQMPDa0GK10eR8231\", ");
	      out.println("    0, 44100, 16);");
	      out.println("");
	      out.println("");
    ...
    /* create the process to run the action */ 
    {
      ...
      if(range != null) {
    	  ...
    	  Integer by = range.getBy();
    	  args.add("1-" + end.toString() + "x" + by.toString()); 
      }
  ...
  private static final long serialVersionUID = -7198720278770699333L;
}
