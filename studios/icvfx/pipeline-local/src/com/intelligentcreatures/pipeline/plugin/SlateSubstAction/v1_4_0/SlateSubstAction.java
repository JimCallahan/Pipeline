package com.intelligentcreatures.pipeline.plugin.SlateSubstAction.v1_4_0; 
...
{  
  ...
  SlateSubstAction() 
  {
    super("SlateSubst", new VersionID("1.4.0"), "ICVFX", 
...

    {
      ActionParam param =
        new StringActionParam
        (aClientShotName,
         "The filename of sequence to be delivered to client as per client's specifications." +
         "This value will be substituted for all instances of \"@IC_FILENAME@\" in " +
         "the template Nuke script.",
         null);
      addSingleParam(param);
    }
