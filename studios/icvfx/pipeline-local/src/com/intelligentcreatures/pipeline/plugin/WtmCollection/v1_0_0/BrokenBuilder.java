// $Id: BrokenBuilder.java,v 1.1 2009/12/02 21:55:32 jim Exp $
...
/*------------------------------------------------------------------------------------------*/
/*   B R O K E N  B U I L D E R                                                             */
/*------------------------------------------------------------------------------------------*/

/**
 * A builder which fails in its constructor.
 */
public 
class BrokenBuilder 
  extends BaseBuilder
{
  ...
  {
    super("Broken",
          "A builder that can't be instantiated.", 
          mclient, qclient, builderInfo); 

     throw new IllegalStateException("This better not work!"); 
  }
