package com.intelligentcreatures.pipeline.plugin.SlateSubstAction.v1_2_0; 
...
{  
  ...
  SlateSubstAction() 
  {
    super("SlateSubst", new VersionID("1.2.0"), "ICVFX", 
  ...
  { 
    ...
    String clientFileName = getSingleStringParamValue(aShotName); 
	...
	while(true) {
	  ...
	  line = sShotName.matcher(line).replaceAll(clientFileName);
  ...
  private static Pattern sShotName = Pattern.compile("@IC_SHOTNAME@"); 
  ...
  static final long serialVersionUID = -1065763039549541965L;
  ...
  public static final String aShotName       = "ShotName"; 
