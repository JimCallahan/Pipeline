package com.intelligentcreatures.pipeline.plugin.SlateSubstAction.v1_1_0; 
...
*    ClientFileName <BR>
*   <DIV style="margin-left: 40px;">
*     The filename of the sequenced delivered to the client as per client's specifications.
*     be substituted for all instances of "@IC_CLIENT_VERSION@" in the template Nuke script.
*   </DIV>
 *   <P> 
 * 
...
{  
  ...
  SlateSubstAction() 
  {
    super("SlateSubst", new VersionID("1.1.0"), "ICVFX", 
    ...
    {  
      ...
      layout.addEntry(aClientFileName);    
      layout.addSeparator();       
  ...
  { 
    ...
    String clientFileName = getSingleStringParamValue(aClientFileName); 
	...
	while(true) {
	  ...
	  line = sClientFileName.matcher(line).replaceAll(clientFileName);
  ...
  private static Pattern sClientFileName = Pattern.compile("@IC_FILENAME@"); 
  ...
  private static final long serialVersionUID = -9167140436769487318L;
  ...
  public static final String aClientFileName       = "ClientFileName"; 
