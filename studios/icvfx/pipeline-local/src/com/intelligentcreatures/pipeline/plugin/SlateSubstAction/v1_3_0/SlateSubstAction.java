package com.intelligentcreatures.pipeline.plugin.SlateSubstAction.v1_3_0; 
...
{  
  ...
  SlateSubstAction() 
  {
    super("SlateSubst", new VersionID("1.3.0"), "ICVFX", 
  ...
  private static final long serialVersionUID = 5485264279477644299L;
