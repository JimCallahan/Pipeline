// $Id: RenderTaskVerifyStage.java,v 1.3 2008/08/01 20:19:15 jim Exp $
  ...
  extends MayaRenderStage
{
   ...
   *
   * @param suffix
   *   The rendered image filename suffix.
   *
   * @param mayaScene
    ...
    throws PipelineException
  {
    ...
    if(renderLayer != null)
    	addSingleParamValue("RenderLayer", renderLayer);
    ...
    throws PipelineException
  {
    this(stageInfo, context, client,
	 nodeName, range, "tif",
	 mayaScene, cameraOverride, preRenderMEL, null);
  }
