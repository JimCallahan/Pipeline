  ...
  extends TaskBuilder
{
    ...
    extends SetupPass
  {
    ...
    FirstInfoPass()
    {
      super("First Info Pass", 
            "The First Information pass for the LaikaShotBuilder");
    }
    ...
    extends SetupPass
  {
    ...
    AssetInfoPass()
    {
      super("Asset Info Pass", 
            "The Asset Information pass for the LaikaShotBuilder");
    }
    ...
    extends ConstructPass
  {
    ...
    {
      super("Build Pass", 
            "The LaikaShotBuilder Pass which constructs the node networks.");
	...
	for (String namespace : pAssets.keySet()) {
	  ...
	  LaikaAssetType type = bundle.pType;
	  String nodename;
	  switch(type) {
	  case Asset:
      ...
      {
	LaikaAnimEditStage stage = 
	  new LaikaAnimEditStage
	  (pStageInfo,
	   pContext,
	   pClient,
	   pMayaContext,
  ...
  class AssetBundle
  {
	...
	pType = LaikaAssetType.SimpleAsset;
	good = true;
      }
