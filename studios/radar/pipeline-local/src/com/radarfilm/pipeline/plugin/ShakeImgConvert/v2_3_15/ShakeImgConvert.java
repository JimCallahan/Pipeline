package com.radarfilm.pipeline.plugin.ShakeImgConvert.v2_3_15;
...
ShakeImgConvert()
{
    super("ShakeImgConvert", new VersionID("2.3.15"), "Radar",
...
public SubProcessHeavy prep (ActionAgenda agenda, File outFile, File errFile ) throws PipelineException {
  ...
  { 
	...
	if(sname == null) 
	  throw new PipelineException
		...
		Path targetShakeStylePath = getWorkingNodeFilePath(nodeID, targetShakeStyleFile);
  ...
  /*----------------------------------------------------------------------------------------*/
	...
	//private static final long serialVersionUID = 4907857062421866020L;
		private static final long serialVersionUID = -6235683689552584083L;
}
