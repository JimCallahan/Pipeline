package com.radarfilm.pipeline.plugin.MencoderEncodeAction.v2_3_14;
...
public
  ...
  {
    super("MencoderEncodeAction", new VersionID("2.3.14"), "Radar",
...
public SubProcessHeavy prep (ActionAgenda agenda, File outFile, File errFile ) throws PipelineException {
  ...
  { 
	...
	if(sname == null) 
	  throw new PipelineException
		...
		NodeID wnodeID = new NodeID(nodeID, wavname);
		
		Path wavepath = null;
		if (wavname != null){
			FileSeq fwav = agenda.getPrimarySource(wavname);
			FilePattern pwav = fwav.getFilePattern();
			String wavfile = (pwav.getPrefix() + "." + pwav.getSuffix()) ;
			wavepath = getWorkingNodeFilePath(wnodeID,wavfile);
		...
		ArrayList<String> args = new ArrayList<String>();
		  ...
		  if (wavepath != null ){
			  ...
			  args.add("-audiofile " + wavepath.toOsString());
		  }
  ...
  /*----------------------------------------------------------------------------------------*/
	...
	private static final long serialVersionUID = -5393731561394021655L;
