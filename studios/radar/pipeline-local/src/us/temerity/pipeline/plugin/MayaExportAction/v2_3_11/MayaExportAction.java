package us.temerity.pipeline.plugin.MayaExportAction.v2_3_11;
...
public
  MayaExportAction()
  {
    super("MayaExport", new VersionID("2.3.11"), "Temerity",
  ...
  /**
   * Construct a {@link SubProcessHeavy SubProcessHeavy} instance
...
imcompatable
   *   information in the action agenda or a general failure of the
prep method code.
   */
  ...
  private static final long serialVersionUID = 4452956410314083014L;
}
